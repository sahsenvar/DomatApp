...
import com.domatapp.core.mapping.converter.platform.UriToStringConverter

/**
 * Android-specific converter registration.
 */
actual object PlatformConverters {
    actual fun register() {
        ...
        // Register Android-specific converters
        TypeConverterRegistry.register(UriToStringConverter)
    }
}
