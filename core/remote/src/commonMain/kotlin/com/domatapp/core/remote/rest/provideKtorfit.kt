...
/**
 * Provides the shared [Ktorfit] instance used to create REST DataSource implementations.
 *
 ...
 *
 * Note: Ktorfit requires [Ktorfit.Builder.baseUrl] to end with `/`, and DataSource paths
