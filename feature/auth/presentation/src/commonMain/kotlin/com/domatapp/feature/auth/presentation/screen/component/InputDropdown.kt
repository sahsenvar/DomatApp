...
fun InputDropdown(
    ...
    val borderColor = if (expanded) DomatColors.Malachite else DomatColors.Slate200
        ...
        Column(
            ...
            Row(
                ...
                Image(
                    ...
                    colorFilter = ColorFilter.tint(
                        if (expanded) DomatColors.Malachite else DomatColors.Slate500,
                    ),
                )
                Text(
            ...
            Row(
                ...
                Image(
                    ...
                    colorFilter = ColorFilter.tint(
                        if (expanded) DomatColors.Malachite else DomatColors.Slate400,
                    ),
                )
            }
        }
                    ...
                    trailingIcon = if (isSelected) {
                        {
                            Image(
                                ...
                                contentDescription = null,
                                modifier = Modifier.size(16.dp),
                                colorFilter = ColorFilter.tint(DomatColors.Malachite),
                            )
                        }
                    } else null,
                    modifier = Modifier.background(
                        if (isSelected) DomatColors.Malachite10
                        else Color.Transparent,
                    ),
                    colors = MenuDefaults.itemColors(),
                )
                if (index < items.lastIndex) {
                    HorizontalDivider(color = DomatColors.Slate100, thickness = 1.dp)
                }
            }
        }
    }
